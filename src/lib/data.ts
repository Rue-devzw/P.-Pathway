    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l1-1-1', title: 'Introduction to the Piano', duration: 320, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l1-1-2', title: 'Proper Posture and Hand Position', duration: 450, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
          { id: 'l1-1-3', title: 'The Musical Alphabet', duration: 610, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
      {
        id: 'm1-2',
        ...
        lessons: [
          { id: 'l1-2-1', title: 'The Staff and Clefs', duration: 550, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l1-2-2', title: 'Note Values and Rhythms', duration: 720, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l2-1-1', title: 'Major Scales', duration: 800, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l2-1-2', title: 'Minor Scales', duration: 850, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
          { id: 'l2-1-3', title: 'Arpeggio Practice', duration: 750, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l3-1-1', title: 'Jazz Chord Voicings', duration: 1200, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l3-1-2', title: 'Classical Harmonic Analysis', duration: 1350, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l4-1-1', title: 'Tuning Your Guitar', duration: 400, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l4-1-2', title: 'Basic Strumming', duration: 550, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
          { id: 'l4-1-3', title: 'Playing Your First Song', duration: 650, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l5-1-1', title: 'Mastering Barre Chords', duration: 900, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l5-1-2', title: 'Introduction to Fingerpicking', duration: 850, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l6-1-1', title: 'The Pentatonic Scale', duration: 1100, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l6-1-2', title: 'Blues Improvisation', duration: 1250, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l7-1-1', title: 'Setting Up Your Kit', duration: 450, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l7-1-2', title: 'Basic Rock Beat', duration: 600, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l8-1-1', title: 'Introduction to Funk Drumming', duration: 950, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l8-1-2', title: 'Creating Musical Fills', duration: 800, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l9-1-1', title: 'The Magic of Ghost Notes', duration: 1150, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l9-1-2', title: 'Understanding Polyrhythms', duration: 1300, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l10-1-1', title: 'Holding the Violin and Bow', duration: 500, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l10-1-2', title: 'Playing Open Strings', duration: 620, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l11-1-1', title: 'Introduction to Vibrato', duration: 1000, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l11-1-2', title: 'Shifting to Third Position', duration: 950, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l12-1-1', title: 'Mastering Double Stops', duration: 1400, videoUrl: '/videos/sample-lesson.mp4', isTrial: true },
          { id: 'l12-1-2', title: 'Advanced Bow Strokes (Spiccato, Sautillé)', duration: 1300, videoUrl: '/videos/sample-lesson.mp4', isTrial: false },
        ],
      },
    ],
  },
